    ...
    public static void main(String[] args) {
        ...
        */
        for (int size = 10; size <= 1000; size *= 10) {
            ...
            int[] reverse = makeReverseArray(size);
            System.out.print("Reversed (" + size + "): ");
            //printArray(reverse);
            long startTime = System.nanoTime();
            selectionSort(reverse);
            long endTime = System.nanoTime();
            long timeElapsed = endTime - startTime;
            //System.out.print("Selection Sort on Reversed Array: ");
            //printArray(reverse);
            //System.out.println("Time elapsed: "+ timeElapsed + " nanoseconds.");

            //Try changing the size of the array by changing the value of makeReverseArray()
            //Does that change the results?
            int[] reverse2 = makeReverseArray(size);
            //System.out.print("size: " + size + " - Reversed Array: ");
            //printArray(reverse2);
            ...
            //System.out.print("Insertion Sort on Reversed Array: ");
            //printArray(reverse2);
            ...
            //Does that change the results?
            int[] almostSorted = makeAlmostSortedArray(size);
            System.out.print("Almost Sorted (" + size + "): ");
            //printArray(almostSorted);
            startTime = System.nanoTime();
            selectionSort(almostSorted);
            endTime = System.nanoTime();
            timeElapsed = endTime - startTime;
            //System.out.print("Selection Sort on Almost Sorted Array: ");
            //printArray(almostSorted);
            //System.out.println("Time elapsed: "+ timeElapsed + " nanoseconds.");

            //Try changing the size of the array by changing the value of makeAlmostSortedArray()
            //Does that change the results?
            int[] almostSorted2 = makeAlmostSortedArray(size);
            ...
            //System.out.println("Insertion Sort on Almost Sorted Array: ");
            //printArray(almostSorted2);
            //System.out.println("Time elapsed: "+ newtimeElapsed + " nanoseconds.\n");
